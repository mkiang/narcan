...
Note that ICD9 years did not include an other_natural code. We code it
as 0 by default, but can be coded however specified in missing_val
parameter. This function flags all opioid deaths that involved other
...
df |>
    ...
    flag_other_natural_present(year = 2019)
#>   year ucod f_records_all opioid_death other_natural_present
#> 1 2019  X42          T402            1                     1
```
