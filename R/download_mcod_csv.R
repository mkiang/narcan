...
#' @param download_dir file path to save download data
#' @param territories download US territories
#'
#' @return none
#' @export
...
download_mcod_csv <- function(year, download_dir = './raw_data',
    ...
    file_name <- sprintf('mort%s%s.csv', ifelse(territories, "terr", ""), year)
